...
public class Perbaikanuts {
    public static void main(String[] args) {
        ...
        input.add(new Mahasiswa("Emon", "Civic Education", 4, 88));
        input.add(new Mahasiswa("wiwi", "Bahasa Inggris", 2, 90));
        input.add(new Mahasiswa("omen", "Ekonomi Mikro", 2, 84));
        input.add(new Mahasiswa("jono", "Pemrograman", 4, 92));
        input.add(new Mahasiswa("ubed", "Teologi Aswaja", 3, 98));
